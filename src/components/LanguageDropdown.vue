<template>
  <div class="language-dropdown">
    ...
    >
      ...
      <span class="ms-1">{{ currentLanguageName }}</span>
      <svg 
        xmlns="http://www.w3.org/2000/svg" 
        width="16" 
        height="16" 
...
export default {
  ...
  computed: {
    currentLanguageName() {
      const lang = this.languages.find(l => l.code === this.i18n.locale.value);
  ...
  mounted() {
    ...
    if (savedLanguage && this.languages.some(l => l.code === savedLanguage)) {
      this.i18n.locale.value = savedLanguage;
    }
